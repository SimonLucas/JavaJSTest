(function (root, factory) {
  ...
  function XEllipse(centre, w, h, dStyle) {
    this.centre = centre;
    this.w = w;
    this.h = h;
  ...
  XEllipse.prototype.copy_ul7ru4$ = function (centre, w, h, dStyle) {
    return new XEllipse(centre === void 0 ? this.centre : centre, w === void 0 ? this.w : w, h === void 0 ? this.h : h, dStyle === void 0 ? this.dStyle : dStyle);
  };
  XEllipse.prototype.toString = function () {
    return 'XEllipse(centre=' + Kotlin.toString(this.centre) + (', w=' + Kotlin.toString(this.w)) + (', h=' + Kotlin.toString(this.h)) + (', dStyle=' + Kotlin.toString(this.dStyle)) + ')';
  };
