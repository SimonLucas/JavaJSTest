(function (root, factory) {
  ...
  Expansion.prototype = Object.create(Enum.prototype);
  Expansion.prototype.constructor = Expansion;
  ...
  function AsteroidsOldKeyController() {
    this.currentKey = null;
    this.keyMap = hashMapOf([to(XKeyMap$Companion_getInstance().left, MoveAction$Left_getInstance()), to(XKeyMap$Companion_getInstance().up, MoveAction$Thrust_getInstance()), to(XKeyMap$Companion_getInstance().right, MoveAction$Right_getInstance()), to(XKeyMap$Companion_getInstance().space, MoveAction$Fire_getInstance())]);
  }
  AsteroidsOldKeyController.prototype.handleKeyEvent_wtf8cg$ = function (e) {
    println(e);
    if (e.t === XKeyEventType$Pressed_getInstance() || e.t === XKeyEventType$Down_getInstance()) {
  ...
  AsteroidsOldKeyController.prototype.getAgentType = function () {
    return 'Asteroids Key Controller';
  };
  AsteroidsOldKeyController.prototype.getAction_84v5ee$ = function (gameState, playerId) {
    ...
    if (key == null)
      ...
      this.currentKey = null;
      return proposed == null ? MoveAction$Neutral_getInstance() : proposed;
    }
  };
  AsteroidsOldKeyController.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'AsteroidsOldKeyController',
    interfaces: []
  };
  function GameLoop() {
    this.gameObjects = HashMap_init();
    this.canCollide = HashMap_init();
  }
  ...
  EasyGraphPlot.prototype.randLines_wb3cd9$ = function (xg, rand) {
    if (rand === void 0)
      rand = Random_0(L1);
    var tmp$, tmp$_0;
  ...
  HelloXGraphics.prototype.paint_vzjx8w$ = function (xg) {
    ...
    var points = makePolygon(void 0, xg.height() / 5, this.hexAngle);
  ...
  function makePolygon(n, rad, startAngle) {
    if (n === void 0)
      n = 6;
    if (rad === void 0)
      rad = 10.0;
  ...
  function Expansion(name, ordinal) {
    Enum.call(this);
    this.name$ = name;
    this.ordinal$ = ordinal;
  }
  function Expansion_initFields() {
    ...
    Expansion$Fill_instance = new Expansion('Fill', 0);
    Expansion$Squash_instance = new Expansion('Squash', 1);
  }
  ...
  Expansion.values = Expansion$values;
  ...
  Expansion.valueOf_61zpoe$ = Expansion$valueOf;
  ...
  LayoutTest.prototype.paint_vzjx8w$ = function (xg) {
    ...
    var panes = layout.hPartition_pk60e5$(xg.width(), xg.height(), 2);
    panes.get_za3lpa$(1).app = this.plotApp;
    var xp = new XPalette(void 0, void 0, void 0, L_1);
    var cIndex = 0;
  ...
  package$arcade.AsteroidsOldKeyController = AsteroidsOldKeyController;
  package$arcade.GameLoop = GameLoop;
  ...
  package$gui.makePolygon_w4xg1m$ = makePolygon;
  ...
  Object.defineProperty(Expansion, 'Fill', {
    get: Expansion$Fill_getInstance
  });
  Object.defineProperty(Expansion, 'Squash', {
    get: Expansion$Squash_getInstance
  });
  package$layout.Expansion = Expansion;
